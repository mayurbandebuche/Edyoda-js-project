...
//     `
//     <div class="card-list">
//     <h3 class="section-heading">Total Items: <span class="item-count">${productList[i].id}</span></h3>
//     <div class="checkout-card">
//      <div>
//       <img class="checkout-product-img" src=${productList[i].preview} alt="">
//      </div>
//      <div>
//       <h4>${productList[i].name}</h4>
//       <p>x1</p>
//       <p><span>Amount: Rs </span><span>${productList[i].price}</span></p>
//      </div>
//     </div>
//   </div>
//   <div>
//     <h3 class="section-heading">Total Amount</h3>
//     <p>Amount: Rs <span class="total-amount">${productList[i].price}</span></p>
